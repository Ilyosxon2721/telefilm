...
//
//     final privateChats = privateChatsFromJson(jsonString);

import 'dart:convert';

PrivateChats privateChatsFromJson(String str) =>
    PrivateChats.fromJson(json.decode(str));

String privateChatsToJson(PrivateChats data) => json.encode(data.toJson());
...
class PrivateChats {
  ...
  factory PrivateChats.fromJson(Map<String, dynamic> json) => PrivateChats(
        id: json["id"],
        isBot: json["is_bot"],
        ...
        detail: json["detail"] == null
            ? null
            : PrivateChatsDetail.fromJson(json["detail"]),
...
class PrivateChatsDetail {
  ...
  factory PrivateChatsDetail.fromJson(Map<String, dynamic> json) =>
      PrivateChatsDetail(
